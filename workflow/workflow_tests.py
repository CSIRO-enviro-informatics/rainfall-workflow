...
from . import settings, parameter_cube, forecast_cube, source_cube, transform, dates, main
...
test_date = settings.FORECAST_DATE
...
def test_parameter_file_creation():
    ...
    observed_xa = None  # Todo: Do this...
    forecast_xa = None  # todo: Do this...
    parameter_cube.generate_forecast_parameters(lat, lon, observed_xa, forecast_xa)
