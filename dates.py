...
def get_start_date(file_path: str):  # Adapted to be usable for getting regridded smips files
    """!
    Find date from which to get new files. Method is hacky and may raise issues.
    **Will have to update with new year, only checks 2019 folder.**
